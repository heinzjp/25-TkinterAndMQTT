...
def main():
    ...
    root.bind('<Up>', lambda event: forward(left_speed_entry, right_speed_entry, mqtt_client))
...
def forward(left_speed_entry, right_speed_entry, mqtt_client):
    left_motor_speed = left_speed_entry.get()
    right_motor_speed = right_speed_entry.get()
    mqtt_client.send_message("forward", ['forward', left_motor_speed, right_motor_speed])
